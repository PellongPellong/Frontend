...
{:else}
    ...
    <div class="relative">
        <div
            class="w-[360px] h-[400px] flex flex-col p-6 pb-10 bg-white border-2 border-gray-200 rounded-3xl shadow-lg transition-all duration-300 cursor-pointer overflow-visible relative {isActive
                ? 'scale-100'
                : 'scale-95'} {isHovered
