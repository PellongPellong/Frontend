...
<div class="relative w-full h-screen overflow-hidden bg-gradient-to-br from-indigo-100 via-cyan-50 to-sky-100">
    ...
    >
        {#each scenes as scene, index}
            <div class="absolute inset-0 flex flex-col transition-opacity duration-700 {currentScene === index ? 'opacity-100' : 'opacity-0'}">
                    ...
                    <div class="h-full flex flex-col justify-end items-center pb-32 animate-fade-in">
                        ...
                        <div class="flex flex-col items-center mb-16">
                            ...
                            <div class="relative mb-6">
                                <div class="glass rounded-3xl px-8 py-5 shadow-2xl max-w-md mx-4">
                                    <p class="text-gray-800 text-center font-bold text-xl md:text-2xl leading-relaxed whitespace-pre-line">
                                        백록과 함께
제주의 숨은 명소를 찾아볼까요?
                                    </p>
                                    <!-- 말풍선 꼬리 (아래로) -->
                                    <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-full">
                                        <div class="w-0 h-0 border-l-[20px] border-l-transparent border-r-[20px] border-r-transparent border-t-[24px] border-t-white/80"></div>
                                    </div>
                                </div>
                            </div>
