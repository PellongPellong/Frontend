! function(t, s) {
    ...
    function t(t, s) {
        if (t[s]) return t[s];
        for (var i, a = Object.keys(t), h = s.toLowerCase().replace(Ot, ""), e = -1; ++e < a.length;)
    ...
    function r(t) {
        ...
        if ("GEOGCS" === t.type ? t.projName = "longlat" : "LOCAL_CS" === t.type ? (t.projName = "identity", t.local = !0) : "object" == typeof t.PROJECTION ? t.projName = Object.keys(t.PROJECTION)[0] : t.projName = t.PROJECTION, t.AXIS) {
            for (var i = "", a = 0, h = t.AXIS.length; a < h; ++a) {
                var r = [t.AXIS[a][0].toLowerCase(), t.AXIS[a][1].toLowerCase()]; - 1 !== r[0].indexOf("north") || "y" === r[0] && "north" === r[1] ? i += "n" : -1 !== r[0].indexOf("south") || "y" === r[0] && "south" === r[1] ? i += "s" : -1 !== r[0].indexOf("east") || "x" === r[0] && "east" === r[1] ? i += "e" : (-1 !== r[0].indexOf("west") || "x" === r[0] && "west" === r[1]) && (i += "w")
            }
    ...
    function q(t, s, i, a) {
        var h, e, n, r, o, l, u, c, M, f, d, p, m, y, _, x, g = t.x,
            v = t.y,
            b = t.z ? t.z : 0;
        if (h = Math.sqrt(g * g + v * v), e = Math.sqrt(g * g + v * v + b * b), h / i < 1e-12) {
            if (y = 0, e / i < 1e-12) return _ = xt, x = -a, {
                x: t.x,
                y: t.y,
                z: t.z
            }
    ...
    var ft = 1,
        ...
        xt = Math.PI / 2,
        gt = .16666666666666666,
        vt = .04722222222222222,
        bt = .022156084656084655,
        wt = 1e-10,
        At = .017453292519943295,
    ...
    var Ft = ["PROJECTEDCRS", "PROJCRS", "GEOGCS", "GEOCCS", "PROJCS", "LOCAL_CS", "GEODCRS", "GEODETICCRS", "GEODETICDATUM", "ENGCRS", "ENGINEERINGCRS"],
        ...
        Jt = function(t, s) {
            for (var i, a, h = .5 * t, e = xt - 2 * Math.atan(s), n = 0; n <= 15; n++)
                if (i = t * Math.sin(e), a = xt - 2 * Math.atan(s * Math.pow((1 - i) / (1 + i), h)) - e, e += a, Math.abs(a) <= 1e-10) return e;
            return -9999
        },
        Kt = [{
            init: function() {
            ...
            forward: function(t) {
                ...
                if (this.sphere) a = this.x0 + this.a * this.k0 * Ht(s - this.long0), h = this.y0 + this.a * this.k0 * Math.log(Math.tan(Nt + .5 * i));
                else {
                    var e = Math.sin(i),
                        n = Xt(this.e, i, e);
            ...
            inverse: function(t) {
                var s, i, a = t.x - this.x0,
                    h = t.y - this.y0;
                if (this.sphere) i = xt - 2 * Math.atan(Math.exp(-h / (this.a * this.k0)));
                else {
    ...
    var as = function(t, s, i) {
        ...
        hs = function(t, s, i) {
            var a, h, e, n = i.x,
                ...
                l = {};
            for (e = 0; e < 3; e++)
                if (!s || 2 !== e || void 0 !== i.z) switch (0 === e ? (a = n, h = -1 !== "ew".indexOf(t.axis[e]) ? "x" : "y") : 1 === e ? (a = r, h = -1 !== "ns".indexOf(t.axis[e]) ? "y" : "x") : (a = o, h = "z"), t.axis[e]) {
                    case "e":
                        l[h] = a;
                        break;
                    case "w":
    ...
    var ys = .01068115234375,
        ...
        vs = {
            ...
            inverse: function(t) {
                ...
                if (this.es)
                    if (s = this.ml0 + n / this.k0, i = gs(s, this.es, this.en), Math.abs(i) < xt) {
                        var r = Math.sin(i),
                            o = Math.cos(i),
        ...
        zs = {
            init: function() {
                ...
                "alpha" in this && (_ = !0);
                var x = !1;
                if ("rectified_grid_angle" in this && (x = !0), _ && (y = this.alpha), x && (c = this.rectified_grid_angle * At), _ || x) M = this.longc;
                else if (f = this.long1, p = this.lat1, d = this.long2, m = this.lat2, Math.abs(p - m) <= Bs || (t = Math.abs(p)) <= Bs || Math.abs(t - xt) <= Bs || Math.abs(Math.abs(this.lat0) - xt) <= Bs || Math.abs(Math.abs(m) - xt) <= Bs) throw new Error;
                var g = 1 - this.es;
            ...
            inverse: function(t) {
                var s, i, a, h, e, n, r, o = {};
                if (t.x = (t.x - this.x0) * (1 / this.a), t.y = (t.y - this.y0) * (1 / this.a), this.no_rot ? (i = t.y, s = t.x) : (i = t.x * this.cosrot - t.y * this.sinrot, s = t.y * this.cosrot + t.x * this.sinrot + this.u_0), a = Math.exp(-this.BrA * i), h = .5 * (a - 1 / a), e = .5 * (a + 1 / a), n = Math.sin(this.BrA * s), r = (n * this.cosgam + h * this.singam) / e, Math.abs(Math.abs(r) - 1) < wt) o.x = 0, o.y = r < 0 ? -xt : xt;
                else {
        ...
        Fs = {
            ...
            forward: function(t) {
                ...
                if (e > wt) a = Xt(this.e, i, Math.sin(i)), h = this.a * this.f0 * Math.pow(a, this.ns);
                else {
        ...
        Zs = {
            ...
            forward: function(t) {
                var s, i, a = t.x,
                    h = t.y;
                if (a = Ht(a - this.long0), this.sphere) s = this.a * Math.asin(Math.cos(h) * Math.sin(a)), i = this.a * (Math.atan2(Math.tan(h), Math.cos(a)) - this.lat0);
                else {
                    var e = Math.sin(h),
                        n = Math.cos(h),
        ...
        $s = .3333333333333333,
        ti = .17222222222222222,
        si = .10257936507936508,
        ii = .06388888888888888,
        ai = .0664021164021164,
        hi = .016415012942191543,
        ei = {
            init: function() {
        ...
        Mi = 20,
            ...
            forward: function(t) {
                var s, i, a, h = t.x,
                    e = t.y,
                    n = Ht(h - this.long0);
                if (a = n * Math.sin(e), this.sphere) Math.abs(e) <= wt ? (s = this.a * n, i = -1 * this.a * this.lat0) : (s = this.a * Math.sin(a) / Math.tan(e), i = this.a * (Ks(e - this.lat0) + (1 - Math.cos(a)) / Math.tan(e)));
            ...
            inverse: function(t) {
                ...
                if (a = t.x - this.x0, h = t.y - this.y0, this.sphere)
                    if (Math.abs(h + this.a * this.lat0) <= wt) s = Ht(a / this.a + this.long0), i = 0;
                    else {
                        n = this.lat0 + h / this.a, r = a * a / this.a / this.a + n * n, o = n;
                        var u;
                        for (e = Mi; e; --e)
                            if (u = Math.tan(o), l = -1 * (n * (o * u + 1) - o - .5 * (o * o + r) * u) / ((o - n) / u - 1), o += l, Math.abs(l) <= wt) {
                                i = o;
                                break
                            }
                        s = Ht(this.long0 + Math.asin(a * Math.tan(o) / this.a) / Math.sin(i))
                    }
                else if (Math.abs(h + this.ml0) <= wt) i = 0, s = Ht(this.long0 + a / this.a);
                else {
                    n = (this.ml0 + h) / this.a, r = a * a / this.a / this.a + n * n, o = n;
                    var c, M, f, d, p;
                    for (e = Mi; e; --e)
                        if (p = this.e * Math.sin(o), c = Math.sqrt(1 - p * p) * Math.tan(o), M = this.a * Us(this.e0, this.e1, this.e2, this.e3, o), f = this.e0 - 2 * this.e1 * Math.cos(2 * o) + 4 * this.e2 * Math.cos(4 * o) - 6 * this.e3 * Math.cos(6 * o), d = M / this.a, l = (n * (c * d + 1) - d - .5 * c * (d * d + r)) / (this.es * Math.sin(2 * o) * (d * d + r - 2 * n * d) / (4 * c) + (n - d) * (c * f - 2 / Math.sin(2 * o)) - f), o -= l, Math.abs(l) <= wt) {
                            i = o;
                            break
                        }
        ...
        vi = {
            ...
            forward: function(t) {
                var s, i, a, h, e, n, r, o, l, u, c, M, f, d, p, m, y, _, x, g, v, b, w, A = t.x,
                    E = t.y,
                    N = Math.sin(t.y),
                    C = Math.cos(t.y),
                    P = Ht(A - this.long0);
        ...
        Ei = {
            ...
            forward: function(t) {
                ...
                if (t.x -= this.long0, s = 0 !== this.es ? Math.atan(this.one_minus_f_squared * Math.tan(t.y)) : t.y, i = t.x, this.face === wi.TOP) h = xt - s, i >= Nt && i <= xt + Nt ? (o.value = Ai.AREA_0, a = i - xt) : i > xt + Nt || i <= -(xt + Nt) ? (o.value = Ai.AREA_1, a = i > 0 ? i - Pt : i + Pt) : i > -(xt + Nt) && i <= -Nt ? (o.value = Ai.AREA_2, a = i + xt) : (o.value = Ai.AREA_3, a = i);
                else if (this.face === wi.BOTTOM) h = xt + s, i >= Nt && i <= xt + Nt ? (o.value = Ai.AREA_0, a = -i + xt) : i < Nt && i >= -Nt ? (o.value = Ai.AREA_1, a = -i) : i < -Nt && i >= -(xt + Nt) ? (o.value = Ai.AREA_2, a = -i - xt) : (o.value = Ai.AREA_3, a = i > 0 ? -i + Pt : -i - Pt);
                else {
                    var l, u, c, M, f, d;
            ...
            inverse: function(t) {
                ...
                if (t.x = (t.x - this.x0) / this.a, t.y = (t.y - this.y0) / this.a, i = Math.atan(Math.sqrt(t.x * t.x + t.y * t.y)), s = Math.atan2(t.y, t.x), t.x >= 0 && t.x >= Math.abs(t.y) ? c.value = Ai.AREA_0 : t.y >= 0 && t.y >= Math.abs(t.x) ? (c.value = Ai.AREA_1, s -= xt) : t.x < 0 && -t.x >= Math.abs(t.y) ? (c.value = Ai.AREA_2, s = s < 0 ? s + Pt : s - Pt) : (c.value = Ai.AREA_3, s += xt), l = Pt / 12 * Math.tan(s), e = Math.sin(l) / (Math.cos(l) - 1 / Math.sqrt(2)), n = Math.atan(e), a = Math.cos(s), h = Math.tan(i), (r = 1 - a * a * h * h * (1 - Math.cos(Math.atan(1 / Math.cos(n))))) < -1 ? r = -1 : r > 1 && (r = 1), this.face === wi.TOP) o = Math.acos(r), u.phi = xt - o, c.value === Ai.AREA_0 ? u.lam = n + xt : c.value === Ai.AREA_1 ? u.lam = n < 0 ? n + Pt : n - Pt : c.value === Ai.AREA_2 ? u.lam = n - xt : u.lam = n;
                else if (this.face === wi.BOTTOM) o = Math.acos(r), u.phi = o - xt, c.value === Ai.AREA_0 ? u.lam = -n + xt : c.value === Ai.AREA_1 ? u.lam = -n : c.value === Ai.AREA_2 ? u.lam = -n - xt : u.lam = n < 0 ? -n - Pt : -n + Pt;
                else {
                    var M, f, d;
    ...
    return W.defaultDatum = "WGS84", W.Proj = Projection, W.WGS84 = new W.Proj("WGS84"), W.Point = Point, W.toPoint = es, W.defs = o, W.nadgrid = function(t, s) {
            ...
            return is[t] = e, e
        }, W.transform = D, W.mgrs = ms, W.version = "2.7.3",
        function(proj4) {
